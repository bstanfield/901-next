...
const listTags = (details) =>
  scale({
    marginBottom: details ? 80 : 20,
    span: {
      display: "inline-block",
      backgroundColor: "rgb(214 214 214 / 36%)",
      color: "#333",
      fontWeight: 500,
      margin: details ? 4 : 3,
      padding: details ? "4px 12px" : "3px 10px",
      borderRadius: "20px",
